...
public class MainActivity extends Activity {
	...
	private static final String URL = "http://143.106.241.1/matioli/testeAPI/";
	...
	private class InvokeWebServiceTask extends AsyncTask<Integer, Void, Integer> {
		...
		private Integer callWebServiceGet(int valor1, int valor2) {
			try {
				...
				params.add(new BasicNameValuePair("n1", String.valueOf(valor1)));
				params.add(new BasicNameValuePair("n2", String.valueOf(valor2)));
